...
const KNOWN = {
  "netflix":        { category: "Entertainment", price: "15.99" },
  "spotify":        { category: "Entertainment", price: "9.99"  },
  "disney+":        { category: "Entertainment", price: "10.99" },
  "disney":         { category: "Entertainment", price: "10.99" },
  "icloud":         { category: "Services",      price: "0.99"  },
  "apple tv+":      { category: "Entertainment", price: "9.99"  },
  "apple tv":       { category: "Entertainment", price: "9.99"  },
  "youtube premium":{ category: "Entertainment", price: "13.99" },
  "youtube":        { category: "Entertainment", price: "13.99" },
  "hbo max":        { category: "Entertainment", price: "15.99" },
  "hbo":            { category: "Entertainment", price: "15.99" },
  "amazon prime":   { category: "Entertainment", price: "8.99"  },
  "prime video":    { category: "Entertainment", price: "8.99"  },
